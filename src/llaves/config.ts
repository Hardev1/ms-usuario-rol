export namespace Keys {
  ...
  export const mensajeEvaluacion = '<br>Tu usuario ya se encuentra registrado en la plataforma, recuerda que tu nombre de usuario es tu correo electrónico y tu contraseña es: ';
